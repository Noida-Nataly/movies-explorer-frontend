...
export const configAmountMovies = {
  ...
  TABLET: 768,
  MOBILE: 320,
  DESKTOP_AMOUNT_MOVIES: 12,
  TABLET_AMOUNT_MOVIES: 8,
  MOBILE_AMOUNT_MOVIES: 5,
  DESKTOP_EXTRA_AMOUNT_MOVIES: 3,
  TABLET_EXTRA_AMOUNT_MOVIES: 2,
  MOBILE_EXTRA_AMOUNT_MOVIES: 2
};